...
public class Vare extends Begrep  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        FAKTURAUTSTEDER("fakturautsteder", "no.novari.fint.model.okonomi.faktura.Fakturautsteder", ONE_TO_ONE, true, "vare"),
        MERVERDIAVGIFT("merverdiavgift", "no.novari.fint.model.okonomi.kodeverk.Merverdiavgift", ONE_TO_ONE, null, null);

...
public class Fakturagrunnlag  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        FAKTURA("faktura", "no.novari.fint.model.okonomi.faktura.Faktura", NONE_TO_MANY, true, "fakturagrunnlag"),
        FAKTURAUTSTEDER("fakturautsteder", "no.novari.fint.model.okonomi.faktura.Fakturautsteder", ONE_TO_ONE, true, "fakturagrunnlag");

...
public class Transaksjon  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        LEVERANDOR("leverandor", "no.novari.fint.model.okonomi.regnskap.Leverandor", NONE_TO_ONE, null, null),
        ANSVARLIG("ansvarlig", "no.novari.fint.model.administrasjon.personal.Personalressurs", NONE_TO_ONE, null, null),
        VALUTA("valuta", "no.novari.fint.model.felles.kodeverk.Valuta", ONE_TO_ONE, null, null),
        POSTERING("postering", "no.novari.fint.model.okonomi.regnskap.Postering", ONE_TO_MANY, false, "transaksjon");

...
public class Sensor  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        SKOLERESSURS("skoleressurs", "no.novari.fint.model.utdanning.elev.Skoleressurs", ONE_TO_ONE, true, "sensor"),
        EKSAMENSGRUPPE("eksamensgruppe", "no.novari.fint.model.utdanning.vurdering.Eksamensgruppe", ONE_TO_ONE, true, "sensor");

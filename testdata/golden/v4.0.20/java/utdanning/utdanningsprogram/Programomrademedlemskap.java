...
public class Programomrademedlemskap extends Gruppemedlemskap  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        ELEVFORHOLD("elevforhold", "no.novari.fint.model.utdanning.elev.Elevforhold", ONE_TO_ONE, true, "programomrademedlemskap"),
        PROGRAMOMRADE("programomrade", "no.novari.fint.model.utdanning.utdanningsprogram.Programomrade", ONE_TO_ONE, true, "gruppemedlemskap");

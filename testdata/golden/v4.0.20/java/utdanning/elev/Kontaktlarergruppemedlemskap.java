...
public class Kontaktlarergruppemedlemskap extends Gruppemedlemskap  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        ELEVFORHOLD("elevforhold", "no.novari.fint.model.utdanning.elev.Elevforhold", ONE_TO_ONE, true, "kontaktlarergruppemedlemskap"),
        KONTAKTLARERGRUPPE("kontaktlarergruppe", "no.novari.fint.model.utdanning.elev.Kontaktlarergruppe", ONE_TO_ONE, true, "gruppemedlemskap");

...
public class Elevtilrettelegging  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        ELEV("elev", "no.novari.fint.model.utdanning.elev.Elevforhold", ONE_TO_ONE, true, "tilrettelegging"),
        FAG("fag", "no.novari.fint.model.utdanning.timeplan.Fag", NONE_TO_ONE, true, "tilrettelegging"),
        TILRETTELEGGING("tilrettelegging", "no.novari.fint.model.utdanning.kodeverk.Tilrettelegging", ONE_TO_ONE, null, null),

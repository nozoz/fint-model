...
public class Applikasjonsressurstilgjengelighet  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        KONSUMENT("konsument", "no.novari.fint.model.administrasjon.organisasjon.Organisasjonselement", ONE_TO_ONE, null, null),
        RESSURS("ressurs", "no.novari.fint.model.ressurs.eiendel.Applikasjonsressurs", ONE_TO_ONE, false, "ressurstilgjengelighet");

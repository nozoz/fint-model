...
public abstract class Lonn  implements FintAbstractObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        ANVISER("anviser", "no.novari.fint.model.administrasjon.personal.Personalressurs", NONE_TO_ONE, null, null),
        KONTERER("konterer", "no.novari.fint.model.administrasjon.personal.Personalressurs", NONE_TO_ONE, null, null),
        ATTESTANT("attestant", "no.novari.fint.model.administrasjon.personal.Personalressurs", NONE_TO_ONE, null, null);

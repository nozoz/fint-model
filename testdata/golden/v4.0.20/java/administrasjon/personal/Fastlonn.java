...
public class Fastlonn extends Lonn  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        LONNSART("lonnsart", "no.novari.fint.model.administrasjon.kodeverk.Lonnsart", NONE_TO_ONE, null, null),
        ARBEIDSFORHOLD("arbeidsforhold", "no.novari.fint.model.administrasjon.personal.Arbeidsforhold", ONE_TO_ONE, true, "fastlonn");

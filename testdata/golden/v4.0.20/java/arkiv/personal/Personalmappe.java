...
public class Personalmappe extends Saksmappe  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        ...
        LEDER("leder", "no.novari.fint.model.administrasjon.personal.Personalressurs", ONE_TO_ONE, null, null),
        ARBEIDSSTED("arbeidssted", "no.novari.fint.model.administrasjon.organisasjon.Organisasjonselement", ONE_TO_ONE, null, null),
        PERSONALRESSURS("personalressurs", "no.novari.fint.model.administrasjon.personal.Personalressurs", ONE_TO_ONE, null, null);

...
public class Skjerming  implements FintComplexDatatypeObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        SKJERMINGSHJEMMEL("skjermingshjemmel", "no.novari.fint.model.arkiv.kodeverk.Skjermingshjemmel", ONE_TO_ONE, null, null),
        TILGANGSRESTRIKSJON("tilgangsrestriksjon", "no.novari.fint.model.arkiv.kodeverk.Tilgangsrestriksjon", ONE_TO_ONE, null, null);

...
public class Klassifikasjonssystem  implements FintModelObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        KLASSIFIKASJONSTYPE("klassifikasjonstype", "no.novari.fint.model.arkiv.kodeverk.Klassifikasjonstype", NONE_TO_ONE, null, null),
        ARKIVDEL("arkivdel", "no.novari.fint.model.arkiv.noark.Arkivdel", ONE_TO_MANY, false, "klassifikasjonssystem");

...
public abstract class Saksmappe extends Mappe  implements FintAbstractObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        SAKSMAPPETYPE("saksmappetype", "no.novari.fint.model.arkiv.kodeverk.Saksmappetype", NONE_TO_ONE, null, null),
        SAKSSTATUS("saksstatus", "no.novari.fint.model.arkiv.kodeverk.Saksstatus", ONE_TO_ONE, null, null),
        TILGANGSGRUPPE("tilgangsgruppe", "no.novari.fint.model.arkiv.kodeverk.Tilgangsgruppe", NONE_TO_ONE, null, null),
        JOURNALENHET("journalenhet", "no.novari.fint.model.arkiv.noark.AdministrativEnhet", NONE_TO_ONE, null, null),
        ADMINISTRATIVENHET("administrativEnhet", "no.novari.fint.model.arkiv.noark.AdministrativEnhet", ONE_TO_ONE, null, null),
        SAKSANSVARLIG("saksansvarlig", "no.novari.fint.model.arkiv.noark.Arkivressurs", ONE_TO_ONE, null, null);

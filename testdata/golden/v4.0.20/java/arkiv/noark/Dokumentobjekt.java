...
public class Dokumentobjekt  implements FintComplexDatatypeObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        ...
        VARIANTFORMAT("variantFormat", "no.novari.fint.model.arkiv.kodeverk.Variantformat", ONE_TO_ONE, null, null),
        OPPRETTETAV("opprettetAv", "no.novari.fint.model.arkiv.noark.Arkivressurs", ONE_TO_ONE, null, null),
        REFERANSEDOKUMENTFIL("referanseDokumentfil", "no.novari.fint.model.arkiv.noark.Dokumentfil", NONE_TO_ONE, null, null);

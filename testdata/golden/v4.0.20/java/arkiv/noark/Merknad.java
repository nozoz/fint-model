...
public class Merknad  implements FintComplexDatatypeObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        MERKNADSTYPE("merknadstype", "no.novari.fint.model.arkiv.kodeverk.Merknadstype", ONE_TO_ONE, null, null),
        MERKNADREGISTRERTAV("merknadRegistrertAv", "no.novari.fint.model.arkiv.noark.Arkivressurs", ONE_TO_ONE, null, null);

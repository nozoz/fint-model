...
public class Journalpost extends Registrering  implements FintComplexDatatypeObject {
    ...
    public enum Relasjonsnavn implements FintRelation {
        JOURNALPOSTTYPE("journalposttype", "no.novari.fint.model.arkiv.kodeverk.JournalpostType", ONE_TO_ONE, null, null),
        JOURNALSTATUS("journalstatus", "no.novari.fint.model.arkiv.kodeverk.JournalStatus", ONE_TO_ONE, null, null),
